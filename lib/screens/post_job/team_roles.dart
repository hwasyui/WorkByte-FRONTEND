                                  ...
                                  if (jobProvider.teamRoles.isEmpty)
                                    const Center(
                                      child: Padding(
                                        ...
                                        child: Text("Add team roles", style: TextStyle(color: Color(0xFFB5B4B4), fontSize: 14)),
                                      ),
                                    )
                                  else
                                    Column(
                                      ...
                                      children: [
                                        ...List.generate(
                                          ...
                                          (index) {
                                            final actualIndex = jobProvider.teamRoles.length - 1 - index;
                                            final role = jobProvider.teamRoles[actualIndex];
                                            return Container(
                                                    ...
                                                    children: [
                                                      Container(
                                                        ...
                                                        decoration: BoxDecoration(
                                                          ...
                                                          border: Border.all(color: const Color(0xFF00AAA8), width: 1.5),
                                                        ),
                                                        child: Center(
                                                          child: Text('${actualIndex + 1}',
                                                              style: const TextStyle(color: Color(0xFF00AAA8), fontWeight: FontWeight.bold)),
                                                        ),
                                                      ),
                                                    ...
                                                    child: ElevatedButton(
                                                      onPressed: () {
                                                        Navigator.push(
                                                          context,
                                                          MaterialPageRoute(
                                                            builder: (context) => PostNewJobAddTeam(
                                        ...
                                        Text('You have ${jobProvider.teamRolesCount} roles team for this job',
      ...
      floatingActionButton: Padding(
        ...
        child: FloatingActionButton(
          ...
          onPressed: () {
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => const PostNewJobAddTeam()),
            );
          },
